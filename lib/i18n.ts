...
const STRINGS = {
  ...
  'profile.supportBody':      { fi: 'TheTotal on ilmainen. Jos haluat tukea kehitystä, voit tehdä Supporter-kertaoston.', en: 'TheTotal is free. If you want to support development, you can make a one-time Supporter purchase.' },
  'profile.supportButton':    { fi: '⭐ Tue kehitystä', en: '⭐ Support development' },
