...
const STRINGS = {
  ...
  'active.saveRetryTitle':     { fi: 'Tallennus ei onnistunut', en: 'Saving did not go through' },
  'active.saveRetryBody':      { fi: 'Treeni on tallessa. Yritämme automaattisesti uudelleen, tai paina Lopeta treeni uudestaan.', en: 'Your workout is safe. We keep retrying automatically, or tap Finish workout again.' },
  'active.sessionExpired':    { fi: 'Istunto vanhentui. Treeni säilyy — yritä tallentaa uudelleen, tai kirjaudu tarvittaessa uudelleen.', en: 'Session expired. Workout is kept — try saving again, or sign in again if needed.' },
  ...
  'mod.blockedUsers':         { fi: 'Estetyt käyttäjät', en: 'Blocked users' },
  'mod.noBlocked':            { fi: 'Ei estettyjä käyttäjiä', en: 'No blocked users' },
  'mod.unblock':              { fi: 'Poista esto', en: 'Unblock' },
  ...
  'friends.challengeAuto':     { fi: 'Haaste on voimassa. Se täyttyy automaattisesti, kun teet treenissä ennätyksen yli {kg} kg.', en: 'The challenge is live. It completes automatically when you set a PR above {kg} kg in a workout.' },
  'friends.duelAuto':          { fi: 'Kaksintaistelu on käynnissä — jokainen treeni lasketaan automaattisesti.', en: 'The duel is running — every workout counts automatically.' },
  'friends.startWorkout':      { fi: 'Aloita treeni', en: 'Start workout' },
